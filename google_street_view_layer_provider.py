...
from .google_street_view_layer_algorithm import GoogleStreetViewLayerAlgorithm


class GoogleStreetViewLayerProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(GoogleStreetViewLayerAlgorithm())
